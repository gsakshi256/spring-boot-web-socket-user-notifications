...
public class NotificationService {
	 ...
	 * @param username
	 *            The username for the user to send notification.
	 */
	...
	public void notify(ArrayList<String> ar, String username) {
		// TODO Auto-generated method stub
		messagingTemplate.convertAndSendToUser(username, "/queue/notify", ar);
		return;
	}
